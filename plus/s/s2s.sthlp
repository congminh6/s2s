...
{phang2}{cmd:.svyset psu [w= hhszwt], strata(strata) singleunit(centered)}{p_end}
...
{pstd}* Model 1 {p_end}
{phang2}{cmd:.s2s dep hhsize age female pri lws ups age0to14sh age15to24sh age60tosh wageemp selfemp area_1 area_2 area_4, by(round) from(5) to(6) pline(povline) cluster(psu) seed(7654321) strata(strata) wt(hhszwt) method(normal) a(1) pline2(epovline) vline(vline) rep(100) b(100)}{p_end}
           
{pstd}* Model 9 {p_end}
{phang2}{cmd:.s2s dep hhsize age female pri lws ups age0to14sh age15to24sh age60tosh wageemp selfemp area_1 area_2 area_4 lnpcewg, by(round) from(5) to(6) pline(povline) cluster(psu) seed(7654321) strata(strata) wt(hhszwt) method(normal) a(1) pline2(epovline) vline(vline) rep(100) b(100)}{p_end}
